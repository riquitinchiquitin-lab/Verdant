      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-6">
        ...
        <div className="flex items-center gap-3 md:gap-4 w-full md:w-auto">
          ...
          <Button 
            ...
            className="flex-1 md:flex-none h-12 md:h-14 px-6 md:px-8 rounded-xl md:rounded-2xl shadow-xl shadow-verdant/20 font-black uppercase tracking-widest flex items-center justify-center gap-2 md:gap-3 transition-all active:scale-95 disabled:grayscale text-[10px] md:text-base"
          >
